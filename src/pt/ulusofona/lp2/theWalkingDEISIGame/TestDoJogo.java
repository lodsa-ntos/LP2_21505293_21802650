...
public class TestDoJogo {
    ...
    public void test01StartGame() {
        ...
        try { /* Para todas as criatutas e equipamentos*/
            ...
            assertEquals(String.valueOf(true), 10,mapaGigante.getInitialTeam());
            assertEquals(String.valueOf(true), 10,mapaGigante.getCurrentTeamId());
    ...
    public void test02IdosoNaNoite() {
        ...
        try {
            ...
            if (idosoNoturno.isDay()) {
                assertEquals(String.valueOf(true), 10,idosoNoturno.getCurrentTeamId());
